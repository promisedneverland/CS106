...
static constexpr auto qt_meta_stringdata_CLASS_Internal_QLabelENDCLASS = QtMocHelpers::stringData(
    "_Internal_QLabel",
    "clicked",
    "",
    "doubleClicked"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASS_Internal_QLabelENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASS_Internal_QLabelENDCLASS_t qt_meta_stringdata_CLASS_Internal_QLabelENDCLASS = {
    {
