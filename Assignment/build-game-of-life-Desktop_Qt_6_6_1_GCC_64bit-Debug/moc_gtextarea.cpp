...
static constexpr auto qt_meta_stringdata_CLASS_Internal_QTextEditENDCLASS = QtMocHelpers::stringData(
    "_Internal_QTextEdit",
    "handleScroll",
    "",
    "value",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASS_Internal_QTextEditENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASS_Internal_QTextEditENDCLASS_t qt_meta_stringdata_CLASS_Internal_QTextEditENDCLASS = {
    {
